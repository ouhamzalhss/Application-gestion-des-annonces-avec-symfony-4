 ...
 *  @UniqueEntity(
 *    fields={"email"},
 *    message="Un autre utilisateur s'est dêja inscrit avec cette adresse email, merci de la modifier"
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\NotBlank(message="vous devez rensegner votre prenom")
     */
    private $firstName;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="vous devez rensegner votre Nom")
     */
    private $lastName;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Email(message="vous devez rensegner un email valide")
     */
    private $email;
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash",message="Vous n'avez pa correctement confirmer votre mot de passe")
     *
     * @var [type]
     */
